...
<body>
	<div class="container">
		...
		<input class="form-control form-control-sm" type="text" min="0" max="89" name="vital" id="vital" style="display:inline-block; width:300px;margin-top:25px;"">
	...
	<script>
		var websocket=new WebSocket("ws://localhost:8008/WebSocket2/VitalCheckEndPoint");
